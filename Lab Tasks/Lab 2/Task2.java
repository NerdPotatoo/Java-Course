/*
    Task 2. Determine actions based on traffic light colors and the presence of
    pedestrians. -using Switch case
    The rules are:
    Green light: "Drive" if no pedestrian is waiting, "Slow down" if a
